...
(function () {
  ...
  function initGame() {
    ...
    new KeyPressListener("KeyW", () => handleArrowPress(0, -1)); // W for Up
    new KeyPressListener("KeyS", () => handleArrowPress(0, 1));  // S for Down
    new KeyPressListener("KeyA", () => handleArrowPress(-1, 0)); // A for Left
    new KeyPressListener("KeyD", () => handleArrowPress(1, 0));  // D for Right
...
music.loop = true; // Loop the music continuously

// Reference to the music toggle button
const toggleMusicButton = document.querySelector("#toggle-music");
let isMusicPlaying = false;

// Add event listener to toggle the music play/pause
